    ...
    <div id="About" className="relative min-h-screen w-full px-8">
      ...
      >
        ...
        <div className="absolute top-[50%] left-[50%] grid w-full -translate-1/2 grid-cols-1 gap-4 px-4 text-center text-white sm:w-3/4 sm:grid-cols-6">
          <m.div
            {...animateEaseText}
            className="col-span-4 col-start-4 row-span-2 grid place-items-center gap-20 text-white md:col-span-3"
          >
            <h1 className="text-lg font-extrabold md:text-2xl">
              The greatest ideas are the simplest
            </h1>
          </m.div>
          <div className="col-span-2 col-start-5 row-span-2 row-start-6 line-clamp-1 grid place-items-center items-center overflow-hidden font-bold overflow-ellipsis text-yellow-300 md:col-span-2 md:row-start-6">
            <ul>
          ...
          <m.span
            {...animateEaseText}
            className="col-span-6 col-start-1 row-span-6 row-start-1 grid place-items-center font-semibold"
          >
